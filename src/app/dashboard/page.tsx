...
export default function Dashboard() {
    ...
    return (
        <>
            <Navbar totalStars={completedChallenges} />
            ...
            <main className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-linear-to-br from-purple-500 to-pink-500 text-white p-6 rounded-2xl shadow-lg">
                        ...
                        <div className="bg-linear-to-br from-blue-500 to-cyan-500 text-white p-6 rounded-2xl shadow-lg">
                            <div className="flex items-center justify-between mb-2">
                                <Target size={40} />
                        ...
                        <div className="bg-linear-to-br from-green-500 to-teal-500 text-white p-6 rounded-2xl shadow-lg">
                            <div className="flex items-center justify-between mb-2">
                                <TrendingUp size={40} />
                        ...
                        <div className="bg-linear-to-br from-yellow-500 to-orange-500 text-white p-6 rounded-2xl shadow-lg">
                            <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="bg-white/80 p-6 rounded-2xl shadow-xl">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-8">
                            <div
                                className="bg-linear-to-r from-purple-500 to-pink-500 h-8 rounded-full flex items-center justify-center text-white font-bold transition-all duration-500"
